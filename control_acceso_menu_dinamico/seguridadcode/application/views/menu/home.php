...
<head>
    ...
    <title>Menu dinamico Codeigniter</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">MENU DINAMICO</a>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <?php foreach ($subtablas as $submenus) { ?>
                                        <?php if ($menus->menid == $submenus->mensubid) { ?>
                                            <li>
                                                <a href="<?php echo base_url("") ?>"><?php echo $submenus->mennombre; ?></a>
                                            </li>
                                        <?php } ?>
                                    <?php } ?>
                                </ul>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2>MENU DINAMICO: Codeigniter and Bootstrap</h2>
            </div>
        </div>
        <!-- /.row -->
